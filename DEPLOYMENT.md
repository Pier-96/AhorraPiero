...
3. El repositorio incluye `.env.production` con `VITE_API_URL=https://ahorrapieroback.onrender.com/api`. En **Settings → Environment Variables** de Vercel, añade ese mismo valor para que quede explícito también en el panel.
...
5. Comprueba `https://ahorrapieroback.onrender.com/api/health` tras el despliegue.
